...
def display_end_sequence():
    messages = [
        "You lose. Reflect on your actions.",
        "Your past actions will change your future.",
...
while running:
    ...
    if player_is_monster:
        if start_hurling_insults and insult_index < len(insults[1]):
            ...
            if insult_timer > 3:  # Display an insult every 3 seconds
    ...
    if all_keys_pressed():
        ...
        if stage < 3:
            ...
            stage = 1
            reversed_levels = True
            reset_stage()
        elif reversed_levels and stage == 3 and insult_index >= len(insults[1]):
            fade_out_in()
